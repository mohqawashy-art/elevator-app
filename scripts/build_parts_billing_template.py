#!/usr/bin/env python3
"""إنشاء static/templates/parts_billing_template.xlsx — نموذج استيراد قطع الغيار."""
import os
import zipfile
from xml.sax.saxutils import escape

ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
OUT = os.path.join(ROOT, 'static', 'templates', 'parts_billing_template.xlsx')
...
<sheets><sheet name="PartsBilling" sheetId="1" r:id="rId1"/></sheets>
</workbook>''')
