/**
 * شريط أذكار التذييل — JSON خارجي + تدوير (ماركوي/تلاشي/كتابة).
 */
(function () {
  var DATA_URL = '/static/data/azkar-duas.json?v=2';
  var SEP = ' · ';
  ...
  function loadData(cb) {
    fetch(DATA_URL, { credentials: 'same-origin' })
      ...
      .catch(function () {
        cb({
          items: shuffleDaily([
            { title: 'التسبيح', text: 'سُبْحَانَ اللَّهِ وَبِحَمْدِهِ', animation: 'fade' },
            { title: 'دعاء الفرج والكرب', text: 'لَا إِلَهَ إِلَّا أَنْتَ سُبْحَانَكَ إِنِّي كُنْتُ مِنَ الظَّالِمِينَ', animation: 'fade' },
          ]),
