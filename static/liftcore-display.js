...
(function (global) {
  ...
  var DOM_SKIP = 'script, style, input, select, textarea, .td-code, .td-actions, .lc-num, .lc-code, .lc-date, .lc-sar, .lc-sar-char, .stat-mini-val, .stat-value, .kpi-val, [data-i18n-skip]';
