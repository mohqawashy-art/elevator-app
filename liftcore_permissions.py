...
PAGE_DEFS: tuple[dict[str, str], ...] = (
    ...
    {'slug': 'attendance', 'label_ar': 'الحضور والانصراف', 'label_en': 'Attendance', 'group_ar': 'الفريق'},
    ...
    {'slug': 'invoices', 'label_ar': 'الفواتير والسندات', 'label_en': 'Invoices & Vouchers', 'group_ar': 'المالية'},
    ...
    {'slug': 'suppliers', 'label_ar': 'الموردون', 'label_en': 'Suppliers', 'group_ar': 'المخزن'},
    {'slug': 'supplier_rfqs', 'label_ar': 'طلبات عروض أسعار الموردين', 'label_en': 'Supplier RFQs', 'group_ar': 'المخزن'},
    {'slug': 'supplier_prices', 'label_ar': 'قائمة أسعار الموردين', 'label_en': 'Supplier Price List', 'group_ar': 'المخزن'},
    ...
    {'slug': 'report_attendance', 'label_ar': 'تقرير الحضور', 'label_en': 'Attendance Report', 'group_ar': 'التقارير'},
    ...
    {'slug': 'report_customer_profitability', 'label_ar': 'ربحية عميل', 'label_en': 'Customer Profitability', 'group_ar': 'التقارير'},
...
LEGACY_GRANT_MAP: dict[str, tuple[str, ...]] = {
    ...
    'attendance.read': (page_perm('attendance', PERM_READ), page_perm('report_attendance', PERM_READ)),
    'attendance.write': (
        page_perm('attendance', PERM_CREATE), page_perm('attendance', PERM_EDIT),
    ),
    'operations.read': (
    ...
    'installation.read': (
        ...
        page_perm('sales_quotes', PERM_READ),
        page_perm('suppliers', PERM_READ),
        page_perm('supplier_rfqs', PERM_READ),
        page_perm('supplier_prices', PERM_READ),
    ),
    'installation.write': (
        ...
        page_perm('sales_quotes', PERM_CREATE), page_perm('sales_quotes', PERM_EDIT),
        page_perm('suppliers', PERM_CREATE), page_perm('suppliers', PERM_EDIT),
        page_perm('supplier_rfqs', PERM_CREATE), page_perm('supplier_rfqs', PERM_EDIT),
        page_perm('supplier_prices', PERM_CREATE), page_perm('supplier_prices', PERM_EDIT),
        page_perm('suppliers', PERM_READ),
        page_perm('supplier_rfqs', PERM_READ),
        page_perm('supplier_prices', PERM_READ),
    ),
...
PATH_PAGE_RULES: tuple[tuple[str, str], ...] = (
    ...
    ('/inventory/opening-stock', 'inventory'),
    ('/inventory/opening-stock/delete', 'inventory'),
    ('/inventory/purchase-invoice', 'inventory'),
    ...
    ('/supplier-price-list', 'supplier_prices'),
    ...
    ('/reports/customer-profitability', 'report_customer_profitability'),
...
PAGE_HOME_PATHS: dict[str, str] = {
    ...
    'report_attendance': '/attendance/monthly',
    ...
    'report_customer_profitability': '/reports/customer-profitability',
