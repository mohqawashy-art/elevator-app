...
class Settings(TenantMixin, db.Model):
    ...
    company_stamp_enabled = db.Column(db.Boolean, default=True)  # إظهار الختم على المستندات
    company_sign_enabled = db.Column(db.Boolean, default=True)   # إظهار التوقيع على المستندات
