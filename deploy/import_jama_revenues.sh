...
#
#   bash deploy/import_jama_revenues.sh --dry-run
#   bash deploy/import_jama_revenues.sh
...
if [ -z "$XLSX" ] || [ ! -f "$XLSX" ]; then
  echo "ERROR: revenues file not found"
...
echo "=============================================="
echo "  Jama import: revenues"
echo "  DB:   $DB_FILE"
echo "  File: $XLSX"
echo "=============================================="

python scripts/import_jama_revenues.py "$XLSX" "${EXTRA[@]}"
